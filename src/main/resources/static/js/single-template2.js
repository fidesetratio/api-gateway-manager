 $(document).ready(function() {
	...
	/* 
	 ...
	 //https://craftpip.github.io/jquery-confirm/#urlprefix
	 ...
	 */
	  ...
	  * class=delme
	  * data-entity-id=100
	  * url-entity-del=home/del
	  * id-to-del=id 
	  * home-index=customtemplate/index
	  * option-id=0 or 1 // auto delete remove or 1 refresh automaticly
	  */
	 delete_me("delme");
	 /*$(".delme").each(function(e){
		var dataEntiyId = $(this).attr("data-entity-id");
